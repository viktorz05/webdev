...
<style>
    ...
    .cpp:hover {
    box-shadow: 0 0 15px 4px rgba(0,122,204,0.8);   /* C++ blue */
    }

    .rust:hover {
    box-shadow: 0 0 15px 4px rgba(247, 118, 24, 0.85); /* Rust orange */
    }

    .svelte:hover {
    box-shadow: 0 0 15px 4px rgba(255, 72, 0, 0.85); /* Svelte lava red */
    }

    .matlab:hover {
    box-shadow: 0 0 15px 4px rgba(178,345, 255, 0.85); /* MATLAB blue */
    }

    .java:hover {
    box-shadow: 0 0 15px 4px rgba(176,114 , 25, 0.85); /* Java brown */
    }

    .javascript:hover {
    box-shadow: 0 0 15px 4px rgba(240, 219, 79, 0.85); /* JavaScript yellow */
    }   

    .webgl:hover {
    box-shadow: 0 0 15px 4px rgba(153, 0, 0, 0.85);
    }
</style>